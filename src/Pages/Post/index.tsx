    ...
    <View style={styles.container}>
      ...
      <View style={styles.textoPostPublicado}>
        <Text>
          ...
          <Text 
          style={styles.textoPostPublicadoLink}>
            https://mockupsfreebies.com/social-media/facebook/free-facebook-mobile-post-mockup
          </Text>
        </Text>
        <Image
          style={styles.imagemPost}source={require("../../assets/post.png")}
        ></Image>
      </View>
      <View style={styles.likes}>
        <Image
          style={styles.likesIcon}source={require("../../assets/likes.png")}
        ></Image>
        <Text style={styles.likesTexto}>9.996</Text>
      </View>
      ...
      <View style={styles.footerPost}>
        <TouchableOpacity style={styles.btnLearMore}>
          <Text style={styles.btnLearMoreText}>ver mais</Text>
        </TouchableOpacity>
